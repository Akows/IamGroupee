...
<body>
       ...
       <div class="row stat-cards">
          <div class="col-md-6 col-xl-12" style="height: 90%;">
            <article class="stat-cards-item" style="margin-top: 4%">
				...
				<form id="lvbWriteForm" method="post">
	...
	<script type="text/javascript">
		var oEditors = [];
			...
			oAppRef: oEditors,
			elPlaceHolder: document.getElementById('lvbContent'),
			sSkinURI: "${root}/resources/smarteditor2/SmartEditor2Skin.html"
			fOnAppLoad: function () { 
		         var lvbTitle = '${thisLvbData.lvbTitle}';               
		         var lvbContent = '${thisLvbData.lvbContent}';      
		         document.getElementById("lvbTitle").value = lvbTitle;     
		         oEditors.getById["lvbContent"].exec("PASTE_HTML", [lvbContent]); 
		     },
		     fCreator: "createSEditor2"
		 });
		var onWrite = function(){
			oEditors.getById["lvbContent"].exec("UPDATE_CONTENTS_FIELD", []);
			var lvbWriteForm = document.getElementById("lvbWriteForm");  
			lvbWriteForm.action ="lvbEnroll";              
			lvbWriteForm.submit();  
		};
		var onModify = function(){
			oEditors.getById["lvbContent"].exec("UPDATE_CONTENTS_FIELD", []);
			var lvbWriteForm = document.getElementById("lvbWriteForm");  
			lvbWriteForm.action ="lvbUpdate";              
			lvbWriteForm.submit();  
		};
