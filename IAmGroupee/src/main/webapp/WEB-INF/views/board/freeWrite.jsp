				...
				<form id="freeWrite" method="post">
		            <div class="card-body p-0">
		              <div class="mailbox-read-info" style="margin-left: 10px; margin-right: 10px;">
		                <input type="text" placeholder="제목을 입력해주세요." id="freeTitle" name="freeTitle" style="border: 1px solid lightgray; width: 100%;">
		              </div>
		              <div class="mailbox-read-message" style="text-align: center; width: 90%; margin: auto; margin-bottom: 10px;">
						<textarea name="freeContent" id="freeContent" rows="10" cols="100" style="width:100%; height:412px; margin: auto;"></textarea>
		              </div>
		            </div>
				  <div class="card-footer clearfix" style="width: 100%; margin: auto;">
			          ...
			          <input type="hidden" name="boardFreeNum" value="${thisFreeData.boardFreeNum}">
                  </div>
                </form>
